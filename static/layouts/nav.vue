<template>
    <div id="side-bar" class="p-0">
        <v-toolbar class="p-0">
            <input @focus="focusCommand()" @blur="blurCommand()" v-model="cli" type="text" class="px-2">
        </v-toolbar>        
        <hr class="my-0">
        <div v-if="menu" class="p-2" style="height: 89.8%">
            <v-menu :data="menu">
        </div>
        <hr class="my-0">
    ...
    module.exports = {
        ...
        mounted() {
            ...
            window.addEventListener('keydown', event => {
                if (this.cli && event.keyCode === 13 && this.focusCli === true) {
